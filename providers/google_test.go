...
func TestNewGoogleProvider(t *testing.T) {
	...
	g.Expect(providerData.LoginURL.String()).To(Equal("https://accounts.google.com/o/oauth2/v2/auth?access_type=offline"))
	...
	g.Expect(providerData.ValidateURL.String()).To(Equal("https://openidconnect.googleapis.com/v1/userinfo"))
